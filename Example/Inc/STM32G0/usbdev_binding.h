...
#define VCOM1_rx_IRQn	TIM16_FDCAN_IT0_IRQn
#define VCOM1_rx_IRQHandler	TIM16_FDCAN_IT0_IRQHandler

#define VCOM1_tx_IRQn	TIM17_FDCAN_IT1_IRQn
#define VCOM1_tx_IRQHandler	TIM17_FDCAN_IT1_IRQHandler
#endif	// > 1
#endif
